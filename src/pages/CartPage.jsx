        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-10">
            ...
            <div className="lg:flex lg:gap-x-8 xl:gap-x-12">
                <div className="flex-auto lg:w-2/3 bg-white rounded-xl shadow-lg p-1 sm:p-6 mb-6 lg:mb-0">
                    {cartItems.map((item) => (
                        <div key={item.productDetails.id}
                             className="flex items-start py-4 sm:py-6 border-b border-gray-200 last:border-b-0">
                            ...
                            <div className="ml-4 flex-auto">
                                <Link to={`/products/${item.productDetails.id}`}
                                      className="hover:text-bank-green transition-colors">
                ...
                <div className="lg:w-1/3 lg:sticky lg:top-24 self-start bg-white rounded-xl shadow-lg p-6">
                    ...
                    <div className="space-y-2 text-sm">
                        <div className="flex justify-between text-bank-gray-DEFAULT">
                            ...
                            <span
                                className="font-medium text-bank-gray-dark">{totalQuantity} {t('piecesAbbreviation', 'шт.')}</span>
                        </div>
                    </div>
                    <div
                        className="flex justify-between text-lg font-bold text-bank-gray-dark mt-4 pt-4 border-t border-gray-200">
                    ...
                    >
                        {t('checkoutButtonText', 'Оформить заказ')}
                    </button>
                    {cartItems.length > 0 && (
                        <button
